...
│   ├── data_sources.md     # карта «индикатор → файл/endpoint» (109 source)
...
| Ежедневный ETL | APScheduler cron 06:00 и 20:00 MSK (все `is_active=true` source-индикаторы; 109 source через `PARSER_REGISTRY`) + late-Minfin 15:00 |
