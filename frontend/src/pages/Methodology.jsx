...
export default function Methodology() {
  useDocumentMeta({
    ...
    description:
      'Как рассчитываются прогнозы экономических показателей России: подготовка ряда, диагностика, статистические модели, обновление и ограничения. Прозрачная методология на официальных данных Росстата, Банка России и Минфина.',
    path: '/methodology',
  });
