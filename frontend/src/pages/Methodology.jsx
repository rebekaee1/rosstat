  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 pt-24 md:pt-28 pb-20 md:pb-24">
      ...
      <section className="mb-16">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className={CARD}>
            ...
            <h3 className="font-semibold text-text-primary mb-1.5">Расчёт, а не суждение</h3>
            <p className={`${P} text-[14px]`}>
      ...
      <section className="mb-16">
        ...
        <p className={`${P} mb-6`}>
          Отказ от прогноза иногда важнее самого прогноза. Статистическая экстраполяция теряет
          смысл там, где динамику задают текущие новости и настроение рынка, а не инерция самого
          ряда.
        </p>
