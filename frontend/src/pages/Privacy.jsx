 ...
 * субъекта. Модель согласия — подразумеваемое (конклюдентное): продолжая
 * пользоваться Сайтом после информирования баннером, посетитель соглашается на
 * cookie. Дата редакции синхронизирована с CONSENT_VERSION в lib/consent.js —
 * при смене редакции поднять обе.
 */
