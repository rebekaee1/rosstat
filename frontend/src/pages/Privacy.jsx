  ...
  return (
    <div className="fe-data-page max-w-3xl mx-auto px-4 md:px-8 pt-24 md:pt-28 pb-20 md:pb-24">
      ...
      <article className="fe-panel fe-reading prose prose-sm max-w-none p-5 sm:p-8">
        ...
        <p className={p}>
          Просмотр аналитического контента Сайта доступен без учётной записи и без указания
          сведений о себе. Скачивание материалов и функции личного кабинета — после бесплатной регистрации.
        ...
        <ul className="list-disc pl-5 space-y-2 mb-4">
          ...
          <li className={li}>
            ...
            значение пароля либо идентификатор входа через сторонний сервис (Google, Яндекс ID, VK ID),
            отображаемое имя и фото профиля (если сервис их передал). При входе через Google
            сохраняется язык версии Сайта, с которой вы вошли; при входе через Яндекс ID или VK ID
            может сохраняться номер телефона (если вы разрешили его передачу). Ведётся служебный журнал входов
        ...
        <ul className="list-disc pl-5 space-y-2 mb-4">
          <li className={li}>
            <strong className="text-text-primary">Google</strong> — если вы выбрали вход через Google,
            браузер перенаправляется на страницу Google для подтверждения входа. Сайт получает
            ID аккаунта, email, имя и ссылку на фото профиля, если они доступны. Доступ к почте,
            контактам и файлам Google не запрашивается; токены Google не сохраняются.
          </li>
          <li className={li}>
