...
export default function Dashboard() {
  ...
  useDocumentMeta({
    title: 'Экономические данные России и прогнозы',
    description:
      'Forecast Economy — бесплатная аналитическая платформа экономических данных России. ' +
      'Официальные данные Росстата, Банка России и Минфина: ВВП, цены, ставки, валюты, рынок труда, население. Без регистрации.',
    path: '/',
  });
