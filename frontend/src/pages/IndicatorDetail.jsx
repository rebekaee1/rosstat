...
const SEO_MAP = {
  ...
  exports: {
    ...
    description: 'Экспорт товаров (платёжный баланс): квартальные данные Банка России.',
  },
  imports: {
    title: 'Импорт товаров в Россию — данные и прогноз',
    description: 'Импорт товаров (платёжный баланс): квартальные данные Банка России.',
  },
  'trade-balance': {
    title: 'Торговый баланс России — данные',
    description: 'Сальдо торгового баланса (экспорт минус импорт): квартальные данные.',
  },
  'exports-yoy': {
    title: 'Экспорт (изменение год к году) — данные',
    description: 'Процентное изменение экспорта к аналогичному кварталу предыдущего года.',
  },
  'imports-yoy': {
    title: 'Импорт (изменение год к году) — данные',
    description: 'Процентное изменение импорта к аналогичному кварталу предыдущего года.',
  },
};
