...
const SEO_MAP = {
  cpi: {
    title: 'Инфляция в России — ИПЦ, данные Росстата и прогноз',
    description: 'Индекс потребительских цен (ИПЦ) России: исторические данные с 1991 года, скользящая 12-месячная инфляция, прогноз на 12 месяцев. Официальные данные Росстата, обновление ежедневно.',
  },
  'cpi-food': {
  ...
  'key-rate': {
    title: 'Ключевая ставка ЦБ РФ на сегодня — график и история',
    description: 'Ключевая ставка Банка России на сегодня: текущее значение, история изменений с 2013 года, график. Официальные данные cbr.ru.',
  },
  'usd-rub': {
    title: 'Курс доллара на сегодня — USD/RUB, график и динамика',
    description: 'Официальный курс доллара к рублю ЦБ РФ на сегодня: ежедневные данные с 1992 года, история, график и динамика. Бесплатно.',
  },
  'eur-rub': {
    title: 'Курс евро на сегодня — EUR/RUB, график и динамика',
    description: 'Официальный курс евро к рублю ЦБ РФ на сегодня: ежедневные данные, история, график. Бесплатно.',
  },
  'cny-rub': {
  ...
  'mortgage-rate': {
    title: 'Ставка по ипотеке в России — график и динамика',
    description: 'Средневзвешенная ставка по ипотечным жилищным кредитам в рублях: данные Банка России, история, график.',
  },
  'deposit-rate': {
    title: 'Ставка по вкладам в России — график и данные ЦБ',
    description: 'Средневзвешенная ставка по вкладам физических лиц в рублях: данные Банка России, динамика.',
  },
  'auto-loan-rate': {
  ...
  'unemployment': {
    title: 'Безработица в России — уровень, данные Росстата и график',
    description: 'Уровень безработицы в России по методологии МОТ: ежемесячные данные Росстата с 2015 года, график динамики. Бесплатно.',
  },
  'wages-nominal': {
    title: 'Средняя зарплата в России — данные Росстата, график',
    description: 'Средняя заработная плата в России: среднемесячная номинальная зарплата, ежемесячные данные Росстата, динамика и график. Бесплатно.',
  },
  'wages-real': {
  ...
  'gdp-nominal': {
    title: 'ВВП России — объём, квартальные данные Росстата',
    description: 'Валовой внутренний продукт (ВВП) России: номинальный объём в текущих ценах, квартальные данные Росстата с 2011 года, график и динамика.',
  },
  'gdp-yoy': {
  ...
  population: {
    title: 'Население России — численность, данные Росстата',
    description: 'Численность населения России: постоянное население РФ, ежегодные данные Росстата с 2010 года, динамика. Бесплатно.',
  },
  ...
  'gold-price': {
    title: 'Цена золота — курс ЦБ РФ сегодня, график',
    description: 'Учётная цена на золото Банка России в рублях за грамм: ежедневные данные, история, график динамики.',
  },
  'exports-qoq': {
...
export default function IndicatorDetail() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 pt-24 md:pt-28 pb-24 md:pb-28">
      ...
      {indicator?.description && (
        <section className="rounded-[2rem] border border-border-subtle bg-surface p-6 md:p-8 shadow-md ring-1 ring-black/[0.06]">
          <h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-text-primary/70 mb-4">
            О показателе
          </h2>
          ...
          {indicator.methodology && (
            <>
              <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-text-primary/70 mt-6 mb-3">
                Методология
              </h3>
              <p className="text-text-secondary leading-relaxed text-[0.95rem]">
                {indicator.methodology}
          ...
          {indicator.source && (
            <p className="text-xs text-text-tertiary mt-4">
              Источник: {indicator.source}
              {indicator.frequency && ` · Частота: ${FREQ_MAP[indicator.frequency] || indicator.frequency}`}
            </p>
          )}
        </section>
      )}
