...
export const VARIANT_GROUPS = [
  ...
  // Автомобильное топливо (звонок 2026-06-25: «объединить АИ-92, АИ-95, дизель»).
  ...
  // полная матрица режимов (свой ViewModePicker). В каталоге показываем
  // номинальную; реальная скрыта из листинга, доступна через pill.
  {
