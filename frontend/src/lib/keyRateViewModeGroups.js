/**
 * Переключатель ключевой ставки — уровень (ежедневно) и сглажение по периодам.
 */

export const KEY_RATE_TOP_GROUPS = [
  {
    id: 'level',
...
export {
  ...
  topGroupForMode,
} from './keyRateViewModeResolve.js';

export function getTopGroup(id) {
  return KEY_RATE_TOP_GROUPS.find((g) => g.id === id);
}
