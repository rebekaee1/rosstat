...
const ANNUAL = {
  description:
    ...
    + 'Рассчитывается как произведение 12 последовательных месячных индексов ИПЦ, '
    + 'делённых на 100, минус 100%.',
  methodology: (
    <>
      <span className="block mb-1">Формула (скользящее окно 12 мес.):</span>
      {ANNUAL_INFLATION_FORMULA}
    </>
  ),
};
