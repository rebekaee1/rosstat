 ...
 *
 * Зачем: floorAd липнет. Обновлять на каждый клик по меню — мигать плашкой
 * и плодить запросы без просмотра (та же дыра fill, только уже людьми).
 * 15 с — ниже медианы живого перехода на 2-ю страницу (18,8 с за 14 дней,
 * behavior_events × behavior_sessions без webdriver/bot-UA). Быстрый проклик
 * меню не мигает; кто прочитал карточку и открыл соседнюю — получает новое
 * объявление. 60 с оставляло без refresh 4 из 5 таких переходов.
 */
