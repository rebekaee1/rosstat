/**
 * Переключатель курса доллара — ежедневный курс и сглаживание по периодам.
 */

export const USD_RUB_TOP_GROUPS = [
  {
    id: 'level',
...
export {
  ...
  topGroupForMode,
} from './usdRubViewModeResolve.js';

export function getTopGroup(id) {
  return USD_RUB_TOP_GROUPS.find((g) => g.id === id);
}
