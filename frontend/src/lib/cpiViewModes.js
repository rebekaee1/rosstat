 ...
 *
 * - inflation: накопленная инфляция за 12 месяцев — rolling-окно (доступно для всех CPI-кодов)
 ...
 * - annual:    годовая инфляция «декабрь к декабрю» — одна точка на каждый
 *              завершённый календарный год (стандарт ЦБ/Росстат). Прогноз —
 *              такое же произведение по 12 месячным точкам прогноза CPI.
