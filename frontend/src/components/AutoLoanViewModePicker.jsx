...
import {
  ...
  getTopGroup,
  highlightedTopGroup,
} from '../lib/autoLoanViewModeGroups';
...
/**
 * Автокредиты: оболочка CpiViewModePicker / PpiViewModePicker, один режим.
 */
export default function AutoLoanViewModePicker({
  currentMode,
  onChange,
  trackContext,
  compact = false,
  ...
  const body = (
    <>
      ...
      <div className="flex flex-wrap gap-2">
        {AUTO_LOAN_TOP_GROUPS.map((group) => {
