...
import {
  ...
  getTopGroup,
  highlightedTopGroup,
} from '../lib/mortgageRateViewModeGroups';
...
/** Ипотека: один режим «уровень ставки». */
export default function MortgageRateViewModePicker({
  currentMode,
  onChange,
  trackContext,
  compact = false,
  ...
  const body = (
    <>
      ...
      <div className="flex flex-wrap gap-2">
        {MORTGAGE_RATE_TOP_GROUPS.map((group) => {
