...
import {
  WAGES_NOMINAL_TOP_GROUPS,
  defaultSubModeForGroup,
  expandedGroupForMode,
  getTopGroup,
  highlightedTopGroup,
} from '../lib/wagesNominalViewModeGroups';
...
export default function WagesNominalViewModePicker({
  currentMode,
  onChange,
  trackContext,
  compact = false,
  ...
  const body = (
    <>
      ...
      <div className="flex flex-wrap gap-2">
        {WAGES_NOMINAL_TOP_GROUPS.map((group) => {
