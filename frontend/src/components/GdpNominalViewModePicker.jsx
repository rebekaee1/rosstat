...
import {
  GDP_NOMINAL_TOP_GROUPS,
  defaultSubModeForGroup,
  expandedGroupForMode,
  getTopGroup,
  highlightedTopGroup,
} from '../lib/gdpNominalViewModeGroups';
...
export default function GdpNominalViewModePicker({
  currentMode,
  onChange,
  trackContext,
  compact = false,
  ...
  const body = (
    <>
      ...
      <div className="flex flex-wrap gap-2">
        {GDP_NOMINAL_TOP_GROUPS.map((group) => {
