...
INDICATORS = [
    ...
    # C2 (звонок 2026-05-21): индекс зарплаты (среднее 2010 = 100). Тот же
    ...
    # сравнивать темпы роста зарплат и недвижимости. Считается из wages-nominal.
    {
        ...
        "methodology": (
            ...
            "среднему значению 2010 года, умноженное на 100. Источник базового ряда — "
            "Росстат, форма П-4."
        ),
        "parser_type": "derived",
        "model_config_json": {
    ...
    # относительно 2010, <100 → ухудшилась. Рассчитывается из двух derived-рядов.
    {
        ...
        "description": (
            ...
            "Значения выше 100 означают, что с 2010 года зарплаты росли быстрее, чем "
            "стоимость жилья (доступность повышается); ниже 100 — наоборот."
        ),
        "methodology": (
            "Расчёт: (индекс зарплаты ÷ индекс цен на вторичное жильё) × 100. Оба индекса "
            "приведены к базе 2010 года. Берётся вторичный рынок как более широкий и менее "
