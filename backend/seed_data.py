...
INDICATORS = [
    ...
    # Служебные ряды МВФ WEO для overlay России в межстрановом рейтинге.
    # Не карточка российского каталога: is_listed=false, источник — МВФ.
    {
        "code": "weo-gdp-usd",
        ...
        "methodology": (
            ...
            "В ряд входят опубликованные значения и оценки выпуска МВФ; "
            "отдельный прогноз на карточке не строится."
        ),
        "parser_type": "imf_weo",
        "model_config_json": {
            "weo_code": "NGDPD",
    ...
    },
    {
        ...
        "methodology": (
            ...
            "оценки выпуска МВФ; отдельный прогноз на карточке не строится."
        ),
        "parser_type": "imf_weo",
        "model_config_json": {
            "weo_code": "NGDPDPC",
