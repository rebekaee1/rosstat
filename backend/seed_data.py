...
INDICATORS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "снижение — смягчение. Для российской аудитории ряд полезен "
            "рядом с курсом доллара и сырьевыми ценами."
        ),
        "methodology": (
    ...
    },
    {
        ...
        "description": (
            ...
            "эталон мирового нефтяного рынка; для России динамика цены "
            "связана с бюджетными поступлениями, курсом рубля и платёжным "
            "балансом."
        ),
        "methodology": (
    ...
    },
    {
        ...
        "description": (
            ...
            "мировой экономики и важна для российского сырьевого экспорта."
        ),
        "methodology": (
    ...
    },
    {
        ...
        "description": (
            ...
            "тепловых единиц по эталонному хабу Henry Hub. Газ — одна "
            "из ключевых статей российского экспорта, а его цена связана с "
            "доходами энергетического сектора."
        ),
        "methodology": (
    ...
    },
    {
        ...
        "description": (
            ...
            "Всемирного банка. Россия — крупнейший экспортёр пшеницы, поэтому "
            "мировые цены связаны с доходами агропромышленного комплекса."
        ),
        "methodology": (
    ...
    },
    {
        ...
        "description": (
            ...
            "сводки цен на сырьё Всемирного банка. Уголь — значимая статья "
            "российского сырьевого экспорта, особенно в страны Азии."
        ),
        "methodology": (
