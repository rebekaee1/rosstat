...
# При двух воркерах: public 2 × (10 + 15) = 50, analytics 2 × (2 + 2) = 8
# соединений максимум, включая временный overflow. Alembic, seed, pg_dump
# и административные подключения требуют отдельного резерва.
