...
# Прод (docker-compose, perf batch 2): web 3 × (8 + 7) = 45, scheduler
# 6 + 6 = 12, analytics 4 процесса × (2 + 2) = 16 → максимум 73, включая
# временный overflow. Alembic, seed, pg_dump и административные подключения
# требуют отдельного резерва (max_connections 100 − 3 reserved).
# До увеличения пулов проверить суммарный бюджет против max_connections.
#
