...
_UNIT_EN = {
    ...
    "изменение к предыдущему периоду": "change over previous period",
    "изменение к тому же периоду прошлого года": "change over same period previous year",
    "темп изменения к предыдущему периоду": "rate of change over previous period",
    ...
    "долларов США": "USD",
    "долларов США за галлон": "USD per gallon",
    "долларов США за баррель": "USD per barrel",
    "долларов США в час": "USD per hour",
    "долларов США (цены 2017) на человека": "USD (2017 prices) per person",
    "тыс. единиц": "thousand units",
    "тыс. единиц в год": "thousand units, annual rate",
    "млн автомобилей в год": "million vehicles, annual rate",
    "индекс (1982 = 100)": "index (1982 = 100)",
    "индекс (1 кв. 1991 = 100)": "index (1991 Q1 = 100)",
