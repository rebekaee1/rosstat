...
страна одна, IP каждый раз новый. UA-фильтр nginx и fail2ban по IP это не
ловят. Поисковики из списка не режутся. Пустой
`RUSTATS_SCRAPE_BLOCK_COUNTRIES` выключает блок.
"""
