...
CATALOG_STEM_ALIASES: tuple[frozenset[str], ...] = (
    frozenset({
        ...
        "prc_hicp_mmor",
        "prc_hicp_mv12r",
        # ECOICOP ver.2 (февраль 2026): живой месячный преемник
        # замороженных midx/aind (1996–2025). Годовой ainr / tec00027 —
        # официальный режим года на той же карточке, не вторая плитка.
        "prc_hicp_minr",
        "prc_hicp_ainr",
        # main table «ГИПЦ, среднегодовой» — короткий хвост того же годового
        # режима; скрыт из листинга, остаётся в merge-группе minr.
        "tec00027",
