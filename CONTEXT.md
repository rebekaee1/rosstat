...
1. **nginx UA-фильтр** (`$bad_bot` → 403): `research`, `scrapy`, `aiohttp`, `okhttp`, `headlesschrome`, пустой UA, **Playwright `Chrome/N.0.0.0 Safari/537.36$`** (ферма 2026-09-04; живой Chrome — build `145.0.7632.xx`, Cursor/Electron не заканчиваются так). Не трогать `10_15_7` — freeze у всех Mac Chrome.
