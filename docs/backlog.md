...
**Last updated:** 2026-06-15 (созвон «ПРАВКИ ПЕРЕДЕЛ»: сглаживание доступности жилья, годовой прогноз = одна точка, прогноз жилья index-annual, окно недельной инфляции, отсечение неполного года, куки default-on под 152-ФЗ. См. История 2026-06-15).
