...
**Файлов:** 947  ·  **Строк:** 260 640  ·  **Токенов (≈):** 2 643 572
...
| `(root)` | 8 | 2 040 | 50 901 |
| `.github` | 1 | 150 | 1 250 |
| `backend` | 516 | 160 763 | 1 551 244 |
| `clickhouse` | 2 | 36 | 445 |
| `deploy` | 9 | 432 | 4 558 |
| `docs` | 39 | 11 526 | 205 287 |
| `frontend` | 312 | 71 721 | 689 449 |
| `mcp` | 3 | 158 | 1 120 |
...
| `backend/tests/test_seo_growth_pages.py` | 655 | 6 124 |
...
| `deploy/approved-shas.txt` | 40 | 717 |
