...
| `backend/app/services/admin_bi.py` | 1 039 | 10 560 |
...
| `frontend/src/pages/RegionsHome.jsx` | 597 | 7 172 |
...
| `frontend/src/pages/RegionIndicatorPage.jsx` | 543 | 6 382 |
...
| `backend/app/tasks/scheduler.py` | 412 | 4 272 |
| `backend/app/api/embed.py` | 478 | 4 116 |
| `backend/tests/test_calendar_seed.py` | 442 | 4 079 |
| `backend/app/services/pulse_report.py` | 366 | 4 056 |
...
| `backend/tests/test_forecast_policy.py` | 376 | 3 879 |
...
| `frontend/src/lib/biLabels.js` | 338 | 3 563 |
| `scripts/regional/parse_pril_2025.py` | 357 | 3 529 |
| `README.md` | 240 | 3 485 |
| `docs/adr/0003-seo-single-source-server-rendered.md` | 181 | 3 484 |
| `backend/app/tasks/analytics_scheduler.py` | 324 | 3 405 |
| `frontend/src/pages/Privacy.jsx` | 261 | 3 344 |
...
| `backend/app/api/seo_pages.py` | 294 | 3 039 |
| `backend/tests/test_seo_growth_pages.py` | 317 | 3 014 |
| `frontend/src/pages/Methodology.jsx` | 240 | 3 009 |
...
| `frontend/src/components/RegionsMap.jsx` | 279 | 2 817 |
...
| `backend/app/services/base_parser.py` | 270 | 2 725 |
...
| `frontend/src/lib/track.js` | 262 | 2 408 |
| `frontend/src/lib/format.js` | 257 | 2 392 |
...
| `frontend/src/lib/compareRepresentation.js` | 182 | 1 908 |
...
| `frontend/src/index.css` | 308 | 1 886 |
...
| `frontend/src/lib/compareRepresentation.test.js` | 165 | 1 796 |
...
| `frontend/src/components/Footer.jsx` | 165 | 1 604 |
...
| `backend/app/services/goal_taxonomy.py` | 204 | 1 561 |
...
| `backend/app/core/cache.py` | 158 | 1 306 |
...
| `frontend/src/pages/About.jsx` | 72 | 1 128 |
...
| `backend/app/services/webmaster_recrawl.py` | 103 | 1 003 |
...
| `frontend/src/components/RegionCrossLink.jsx` | 69 | 881 |
...
| `backend/tests/test_ssr_matrix.py` | 101 | 831 |
...
| `backend/tests/test_minfin_budget.py` | 99 | 785 |
...
| `backend/app/data/legacy_redirects.py` | 62 | 673 |
...
| `frontend/src/lib/biLabels.test.js` | 58 | 617 |
...
| `backend/tests/test_export.py` | 59 | 538 |
...
| `frontend/src/pages/ComparePage.component.test.jsx` | 45 | 432 |
...
| `frontend/src/components/VariantGroupPicker.jsx` | 48 | 385 |
...
| `frontend/src/components/RegionsMap.component.test.jsx` | 36 | 371 |
| `backend/alembic/env.py` | 54 | 370 |
| `backend/constraints.txt` | 73 | 369 |
...
| `backend/app/api/router.py` | 32 | 355 |
...
| `backend/app/services/http_client.py` | 37 | 309 |
| `frontend/package.json` | 49 | 306 |
...
| `frontend/src/test/setup.js` | 29 | 230 |
...
| `frontend/vitest.config.js` | 16 | 147 |
...
| `backend/tests/test_http_client.py` | 15 | 117 |
| `backend/requirements.txt` | 25 | 116 |
