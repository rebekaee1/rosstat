...
report.baseline = 'output/design-acceptance/results/source-audit.json';
...
for (const relative of ['final/all.json', 'final-narrow/http.json', 'final-narrow/browser.json', 'final-us-images-before.json', 'final-us-images-after.json']) {
  const file = path.join(root, 'output/design-acceptance/results', relative);
...
const file = path.join(root, 'output/design-acceptance/results/final-source-audit.json');
